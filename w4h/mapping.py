...
def read_model_grid(gridpath, study_area=None, no_data_val=0, read_grid=True, node_byspace=False, clip2studyarea=True, study_area_crs=None, grid_crs=None, log=False):
...
def read_grid(datapath='', grid_type='model', no_data_val=0, use_service=False, study_area=None, clip2studyarea=True,  study_area_crs=None, grid_crs=None, log=False, **kwargs):
    """Reads in grid
    ...
    if grid_type=='model':
        if 'read_grid' in list(kwargs.keys()):
            ...
            rgrid=True
        gridIN = read_model_grid(study_area, gridpath=datapath, no_data_val=0, read_grid=rgrid, clip2studyarea=clip2studyarea, study_area_crs=study_area_crs, grid_crs=grid_crs)
    else:
